...
int main()
{
    ...
    double *px = sum2(2, 7); //return is an address not the value 
    std::cout << "sum 2 = 2 + 7 = " << *px << std::endl;
    delete px;
...
double *sum2(double a, double b) // THIS type of functions is renamed this way cuz it return address 
{
...
double *sum3(double *p_a, double *p_b)
{
    ...
    // WHY didn't we write *p_results = new double (*p_a + *p_b); directly ??!!
...
// Hint: use absolute fdouble absolute_difference3(double &a, double &b)
...
// Your explanation:   becasue its a void function so it won't return neither a nor b unlike P11 and P10 referencing and pointers help in changing the values of variabls without return.
void swap3(double a, double b)
{
    double temp_a = a;
    a = b;
